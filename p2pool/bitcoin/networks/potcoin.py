...
BLOCK_EXPLORER_URL_PREFIX = 'http://chainz.cryptoid.info/pot/block.dws?'
ADDRESS_EXPLORER_URL_PREFIX = 'http://chainz.cryptoid.info/pot/address.dws?'
TX_EXPLORER_URL_PREFIX = 'http://chainz.cryptoid.info/pot/tx.dws?'
